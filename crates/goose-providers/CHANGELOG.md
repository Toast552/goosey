...
## [0.1.0-alpha.11](https://github.com/Toast552/goosey/compare/gdk-v0.1.0-alpha.10...gdk-v0.1.0-alpha.11) - 2026-09-25

### Fixed

- *(databricks_v2)* send Claude model services through the Anthropic route ([#12486](https://github.com/Toast552/goosey/pull/12486))
